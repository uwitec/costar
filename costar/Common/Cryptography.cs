...
namespace Common
{
    public class Cryptography
    {
        ...
        {
            // Hacky work-around to avoid "Invalid length for a Base-64 char array" exception
            // which seems to occur if there's a space in the string.
            // Replacing it with a + works since that seems to get converted to a space
            // by Convert.FromBase64String at the next step.
            // http://forums.asp.net/t/1222829.aspx

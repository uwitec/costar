...
-- *******************
IF NOT EXISTS (SELECT * FROM AppliedUpdates WHERE Name = '20140227-SX-1')
BEGIN
...
IF NOT EXISTS (SELECT * FROM AppliedUpdates WHERE Name = '20140227-SX-1')
BEGIN
   INSERT INTO AppliedUpdates(Name) Values ('20140227-SX-1')
END
GO
-- *******************
-- END 20140227-SX-1
...
-- *******************
-- START 20140227-SX-2
-- CREATE AccountPermissions Table
-- *******************
IF NOT EXISTS (SELECT * FROM AppliedUpdates WHERE Name = '20140227-SX-2')
BEGIN
...
IF NOT EXISTS (SELECT * FROM AppliedUpdates WHERE Name = '20140227-SX-2')
BEGIN
	ALTER TABLE [dbo].[AccountPermissions]  WITH CHECK ADD  CONSTRAINT [FK_AccountPermissions_Accounts] FOREIGN KEY([AccountID])
	REFERENCES [dbo].[Accounts] ([AccountID])
END
GO
...
IF NOT EXISTS (SELECT * FROM AppliedUpdates WHERE Name = '20140227-SX-2')
BEGIN
	ALTER TABLE [dbo].[AccountPermissions]  WITH CHECK ADD  CONSTRAINT [FK_AccountPermissions_Permissions] FOREIGN KEY([PermissionID])
...
IF NOT EXISTS (SELECT * FROM AppliedUpdates WHERE Name = '20140227-SX-2')
BEGIN
   INSERT INTO AppliedUpdates(Name) Values ('20140227-SX-2')
END
GO
-- *******************
-- END 20140227-SX-2
